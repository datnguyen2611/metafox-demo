...
export default function overridesComponents(theme: Theme): void {
  ...
  theme.components.MfMiniAppBarBlock = {
    styleOverrides: {
      root: {
        '& form': {
          alignItems: 'end'
  ...
  theme.components.AppBarLogo = {
    styleOverrides: {
      root: {
        width: 'calc(max(50vw - 512px - 16px, 200px))'
      }
    }
  };

  theme.components.MfAppBarMini = {
    defaultProps: {
  ...
  theme.components.MfHeaderSearchForm = {
    styleOverrides: {
      root: {
        width: 512,
      ...
      rootPlacementCenter: {
        [theme.breakpoints.up('md')]: {
          left: 'calc(max(50vw - 512px, 200px))',
          transform: 'translateX(0)'
        }
      },
      form: {
