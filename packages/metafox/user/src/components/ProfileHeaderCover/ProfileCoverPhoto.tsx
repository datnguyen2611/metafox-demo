...
const ImagePositionBox = styled('div', {
  ...
  overridesResolver(props, styles) {
    return [
      props.isUpdateAvatar && styles.ImagePositionUpdateAvatar,
      styles.ImagePositionBox
    ];
  }
})<{ isUpdateAvatar?: boaolean }>(({ theme, isUpdateAvatar }) => ({
  height: 320,
  overflow: 'hidden',
  position: 'relative',
        ...
        >
          ...
          >
            ...
            >
              ...
              ) : hasCoverPhoto && can_view_cover_detail ? (
                <Link
                  to={isLogged && to}
                  asModal
