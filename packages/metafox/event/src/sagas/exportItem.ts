...
function* exportItem(action: ItemLocalAction) {
  ...
  const config = yield* getItemActionConfig(item, 'exportItem');
...
const sagas = [takeEvery('event/exportItem', exportItem)];
