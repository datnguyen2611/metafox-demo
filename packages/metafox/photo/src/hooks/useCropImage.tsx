...
export default function useCropImage({
  ...
  }, [document, onDocMouseTouchEnd, onDocMouseTouchMove]);
  ...
  const bindDocMove = React.useCallback(() => {
    document.addEventListener('mousemove', onDocMouseTouchMove);
    document.addEventListener('touchmove', onDocMouseTouchMove, {
      passing: false
    });

    document.addEventListener('mouseup', onDocMouseTouchEnd);
    document.addEventListener('touchend', onDocMouseTouchEnd, {
      passing: false
    });
    document.addEventListener('touchcancel', onDocMouseTouchEnd, {
      passing: false
    });
  }, [document, onDocMouseTouchEnd, onDocMouseTouchMove]);
