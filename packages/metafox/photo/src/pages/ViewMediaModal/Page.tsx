 ...
 * path: /photo/:photo_id(\d+), /photo/:photo_set(\d+)/:photo_id(\d+), /media/:photo_set(\d+)/:media_type/:photo_id(\d+), /media/album/:photo_album(\d+)/:media_type/:photo_id(\d+)
 * bundle: web
 */
import { fetchDetail, useGlobal, useAbortControl } from '@metafox/framework';
