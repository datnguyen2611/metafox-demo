  ...
  ({
    ...
    ...(lines > 1 &&
      ...
      notSupportLineClamp === true && {
        ...
        maxHeight: `calc(${theme.typography[variant].lineHeight} * ${theme.typography[variant].fontSize} * ${lines} - (${theme.typography[variant].lineHeight} * ${theme.typography[variant].fontSize} * 0.1))`,
