...
export default function ItemPhotoField({
  ...
  const { dialogBackend, i18n, useIsMobile } = useGlobal();
  const [, meta, { setValue, setTouched }] = useField(name ?? 'ItemPhotoField');
          ...
          >
            ...
            >
              ...
              <Tooltip title={i18n.formatMessage({ id: 'remove' })}>
                <RemoveBtn
                  onClick={formik.isSubmitting ? null : handleDeletePhoto}
                >
