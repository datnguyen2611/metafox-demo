...
import TypeBoldIcon from '../../images/icons/type-bold.svg';
import TypeItalicIcon from '../../images/icons/type-italic.svg';
import TypeUnderlineIcon from '../../images/icons/type-underline.svg';
...
const FloatTextContainer = styled(Box, {
  name,
  slot: 'FloatTextContainer'
})(({ theme }) => ({
  display: 'flex',
